...
# → XRP/USD on BOTH exchanges
# → Real USD balances only
# → 24/7 background auto-trading (even when logged out)
# → ALL original endpoints restored (no more 404s)
...
@app.get("/")
async def root():
    return {"message": "Passive Crypto Income — XRP/USD Arbitrage Bot — Running 24/7"}
